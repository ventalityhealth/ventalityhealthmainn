      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-3">
            <div className="relative aspect-square bg-[#0f0f0f] border border-white/8 rounded-sm overflow-hidden">
              {images[0] ? (
                <Image
                  src={images[0].url}
            ...
            {images.length > 1 && (
              <div className="grid grid-cols-4 gap-2">
                {images.slice(1, 5).map((img, i) => (
                  <div
                    key={i}
                    className="relative aspect-square bg-[#0f0f0f] border border-white/8 rounded-sm overflow-hidden"
                  >
                    <Image
                      src={img.url}
